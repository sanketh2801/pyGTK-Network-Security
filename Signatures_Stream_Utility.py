...
class PyApp:
    ...
    def create_configuration_table(self):
        ...
        title_bar = ['SID', 'L1 Hashes', 'L2 Hashes', 'Select', 'Size (bytes)', 'Signature (Count, ID, Start, End ...)', 'SLR (0,1,2,3,4)']
        for i in range(7):
            label = gtk.Label(title_bar[i])
        ...
        title_bar = ['SID', 'L1', 'L2', 'Select', 'Size', 'Pattern', 'SLR']
        for i in range(7):
    ...
    def create_configuration_window(self, widget, data, streams_df):
        ...
        menu_items4 = (
            ...
            ( "/File/_Load Stream Binary file",     "<control>O", self.load_binary_after_config, 0, None ),
            ( "/File/_Save Stream Binary file",     "<control>S", self.save_binary_after_config, 0, None ),
    ...
    def save_binary_stream_output(self, widget, data):
        ...
        for ctr in range(self.current_index):
            ...
            if(pattern_data!=''):
                ...
                SLR_val = self.generate_load_line(sorted(size_arr_for_bin, reverse = True))[2:]              
            ...
            stream_df_map.loc[ctr]=[SID, Size_stream, Hex, str(pattern_val), SLR_val, 0, 0]
